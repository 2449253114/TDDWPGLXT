...
const lantuPayConfig = {
	...
	// 支付异步通知地址
	notify_url: "https://fc-mp-9909fa0f-9b68-46fb-afbb-997488dc33b3.next.bspapp.com/api/user/payment/v2/lantu_notify_url",
	// 支付成功后自动跳转到该地址
	return_url: "https://fc-mp-9909fa0f-9b68-46fb-afbb-997488dc33b3.next.bspapp.com/api/user/payment/v2/lantu_return_url",
	//return_url: "https://tcb-634t34mepexy3wb-6cyg21f2ed1b.service.tcloudbase.com/api/v1/pay/bluetu_pay_return/return_url",
	// 取消支付自动跳转到该地址
	quit_url: "https://fc-mp-9909fa0f-9b68-46fb-afbb-997488dc33b3.next.bspapp.com/api/user/payment/v2/lantu_quit_url",
	// 订单失效时间
	time_expire: "30m",
