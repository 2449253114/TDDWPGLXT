...
module.exports = async function() {
	...
	last_create_time = last_create_time == 0 ? Math.floor(Date.now() / 1000) : last_create_time;

	// 获取文件列表
	// 调用函数获取随机采样的文件列表
	//let result = await getRandomSampleFiles(fileCollection, albumCollectionName, categoryList, last_create_time, pageSize);
