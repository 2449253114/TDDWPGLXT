<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="name,create_date" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            <uni-td align="center">
			  <uni-tag type="primary" :inverted="false" size="normal" :text="item.name"></uni-tag>
			</uni-td>
            <uni-td align="center">
...
<script>
  import { enumConverter, filterToWhere } from '@/js_sdk/validator/system-app-tag.js';
