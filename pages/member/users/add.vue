<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="score" label="用户金币">
        <uni-easyinput placeholder="用户积分（用于金币），积分变更记录可参考：uni-id-scores表定义" type="number" v-model="formData.score"></uni-easyinput>
      </uni-forms-item>
      ...
      <uni-forms-item name="inviter_uid" label="邀请人">
        <uni-easyinput placeholder="邀请人ID" v-model="formData.inviter_uid"></uni-easyinput>
      </uni-forms-item>
      <uni-forms-item name="invite_time" label="受邀时间">
        <uni-datetime-picker return-type="timestamp" v-model="formData.invite_time"></uni-datetime-picker>
      </uni-forms-item>
	  -->
      <uni-forms-item name="my_invite_code" label="我的邀请码">
        <uni-easyinput placeholder="用户自身邀请码" v-model="formData.my_invite_code"></uni-easyinput>
      </uni-forms-item>
      <uni-forms-item name="device_oaid" label="设备oaid">
        <uni-easyinput placeholder="设备oaid" v-model="formData.device_oaid"></uni-easyinput>
      </uni-forms-item>
	  <!-- 
      ...
      <uni-forms-item name="avatar" label="头像地址">
        <!-- <uni-easyinput placeholder="头像地址" v-model="formData.avatar" trim="both"></uni-easyinput> -->
      		<image :src="formOptions.avatar" style="width: 50px;height: 50px;" mode="aspectFill"/>
      		<uni-file-picker ref="files" style="width: 100px;" :auto-upload="true" limit="9" v-model="imageValue"
      ...
      <uni-forms-item name="login_date" label="最后登录时间">
        <uni-datetime-picker return-type="timestamp" v-model="formData.login_date"></uni-datetime-picker>
      </uni-forms-item>
      <uni-forms-item name="login_ip" label="最后登录时 IP 地址">
        <uni-easyinput placeholder="最后登录时 IP 地址" v-model="formData.login_ip"></uni-easyinput>
      </uni-forms-item>
      <uni-forms-item name="register_date" label="注册时间">
        <uni-datetime-picker return-type="timestamp" v-model="formData.register_date"></uni-datetime-picker>
      </uni-forms-item>
      <uni-forms-item name="register_ip" label="注册时 IP 地址">
        <uni-easyinput placeholder="注册时 IP 地址" v-model="formData.register_ip"></uni-easyinput>
      </uni-forms-item>
