  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      <uni-forms-item name="album_id" label="album_id">
        <uni-easyinput placeholder="一刻相册_相册id" v-model="formData.album_id" :disabled="true"></uni-easyinput>
      </uni-forms-item>
...
<script>
  ...
  export default {
    ...
    methods: {
       ...
       */
      submitForm(value) {
		value.create_time = value.create_time / 1000 // 转为秒单位
        // 使用 clientDB 提交数据
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("album_id,create_time,title,custom_title,pic_count,video_count,total_count,price,status,cover_info").get().then((res) => {
